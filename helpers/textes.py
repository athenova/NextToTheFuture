...
def gen_text(task):
    ...
    if not os.path.exists(problem_file_name):
        ...
        text = client.chat.completions.create(
                    model=AI_TEXT_MODEL,
                    messages=[
                        { "role": "system", "content": f"Ты - коуч будущего с передовыми техниками, нестандартными инсайтами и проверенными стратегиями, которые помогут твоим клиентам создать свою новую реальность" },
