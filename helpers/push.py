        ...
        for i, file in enumerate(files):
            ...
            for item in data:
                task = { 
                    ...
                    "solution_prompt": f"Опиши решение проблемы '{item['problem']}' с помощью техники '{item['technic']}' из области '{item['group']}', создай заголовок и выдели его одиночными обратными апострофами, используй не более {TOPIC_WORD_LIMIT} слов",
